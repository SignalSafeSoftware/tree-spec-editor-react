...
The package documentation includes a live preview generated by the exported
`TreeSpecGraphEditor`; see [tree-spec-example-flow.svg](./tree-spec-example-flow.svg).
The source data and browser-backed generator are in [`demo/`](./demo/).
